...
public class DemoShooting : MonoBehaviour
{
    ...
    public DemoProjectiles[] Prefabs;
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            Instantiate(Prefabs[Prefab].Prefabs, FirePoint.transform.position, FirePoint.transform.rotation);
        }
